/**
 * Module for rendering PlantUML diagrams to PNG images.
 * 
 * @module plantuml
 */
const plantuml = (() => {
    /**
     * Initializes the PlantUML compiler.
     * 
     * @async
     * @param {string} [cheerpjPath="/app/assets/lib"] - The path to CheerpJ library.
     */
    ...
    /**
     * Renders a PlantUML diagram to a PNG image blob.
     * 
     * @param {string} pumlContent - The content of the PlantUML diagram.
     * @returns {Promise<Blob>} - A promise resolving to the PNG image blob.
     */
